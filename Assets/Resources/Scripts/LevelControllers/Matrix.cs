...
public class Matrix : GameController {
	...
	public IEnumerator LevelExecution() {
        ...
        //SetToDefaultScheme();
        //WarningArea(Color.black, -90f, 90f, 1f, true, true);
		...
		yield return StartCoroutine(WaitForTime (1f));
		LaserCutter (Color.black, 0f, 180f, 1f, true);
		yield return StartCoroutine(WaitForTime (1f));
		yield return StartCoroutine(WaitForTime (0.2f));
		...
		SpreadOrbPattern (Color.black, new Vector2 (5f, 5f), 180f, 3f, 9, 10);
		yield return StartCoroutine(WaitForTime (1f));
		LaserCutter (Color.black, 90f, 180f, 1f, true);
		yield return StartCoroutine(WaitForTime (1f));
		SpreadOrbPattern (Color.black, new Vector2 (5f, 5f), 180f, 3f, 9, 10);
		yield return StartCoroutine(WaitForTime (0.5f));
        ...
        WarningArea(Color.black, -40f, 40f, 0.5f);
        WarningArea(Color.black, 140f, -140f, 0.5f);
        yield return StartCoroutine(WaitForTime (0.5f));
		DoubleBlasts();
		InfernoSlashes();
		...
		ChoppingBeam (Color.yellow, 315f, 0.25f, 0f, false, 2.5f);
		yield return StartCoroutine (WaitForTime (0.25f));
		LaserCutter (Color.red, 0f, 170f, 0.25f, false);
		LaserCutter (Color.yellow, -0f, -170f, 0.25f, false);
		yield return StartCoroutine (WaitForTime (0.5f));
		PlayerCrusher (Color.red, new Vector2 (2.5f, 100f), 0f, 0.25f);
        ...
        SpreadOrbExplosion(Color.yellow, new Vector2(5f, 5f), 0f, 5f, 12, 30f, new Vector2(UnityEngine.Random.Range(-100f, 100f), UnityEngine.Random.Range(-25f, 25f)));
        yield return StartCoroutine(WaitForTime(0.25f));
        LaserCutter(Color.red, 0f, 360f, 2f, false);
        for (int i = 0; i < 24; i++)
        {
            int Direction = 15 * i;
            if (i % 2 == 0)
        ...
        #region Glowy II 
        SetToGlowyScheme();
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 180f, 2f, true);
        yield return StartCoroutine(WaitForTime(2f));
        LaserCutter(new Color32(120, 255, 90, 255), -0f, -180f, 2f, true);
        yield return StartCoroutine(WaitForTime(1.75f));
        ...
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 180f, 2f, true);
        yield return StartCoroutine(WaitForTime(0.5f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 180f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(0.5f));
        LaserCutter(new Color32(120, 255, 90, 255), -0f, -180f, 1.25f, true);
        yield return StartCoroutine(WaitForTime(1f));
        ...
        PlayerCrusher(new Color32(120, 255, 90, 255), new Vector2(2.5f, 100f), 0f, 0.2f);
        yield return StartCoroutine(WaitForTime(0.25f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 90f, 1f, true);
        yield return StartCoroutine(WaitForTime(0.25f));
        LaserCutter(new Color32(120, 255, 90, 255), -0f, -90f, 1f, true);
        yield return StartCoroutine(WaitForTime(0.25f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 180f, 1f, true);
        yield return StartCoroutine(WaitForTime(1f));
        ...
        SpreadOrbExplosion(new Color32(120, 255, 90, 255), new Vector2(2.5f, 2.5f), 0f, 5f, 18, 20f, new Vector2(UnityEngine.Random.Range(-50f, 50f), UnityEngine.Random.Range(-50f, 50f)));
        yield return StartCoroutine(WaitForTime(0.5f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 225f, 1f, true);
        yield return StartCoroutine(WaitForTime(1f));
        ...
        yield return StartCoroutine(WaitForTime(1f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 135f, 1f, true);
        yield return StartCoroutine(WaitForTime(1f));
        LaserCutter(new Color32(120, 255, 90, 255), -0f, -135f, 1f, true);
        yield return StartCoroutine(WaitForTime(1f));
        LaserCutter(new Color32(120, 255, 90, 255), 0f, 135f, 1f, true);
        ...
        yield return StartCoroutine(WaitForTime(0.25f));
        GameObject Slicer = new GameObject();
        for (int i = 0; i < 40; i++)
        {
            Transform SlicerPiece;
            if (i % 2 == 0)
            {
                SlicerPiece = Square(Color.yellow, new Vector2(5f, 2.5f), 3);
            } else
            {
                SlicerPiece = Square(Color.red, new Vector2(5f, 2.5f), 3);
            }
            SlicerPiece.position = new Vector2(0f, -100f + i * 10);
            SlicerPiece.SetParent(Slicer.transform);
        }
        Slicer.transform.position = Vector2.zero;
        Orbit(Slicer.transform, 360f, 2.5f);
        yield return StartCoroutine(WaitForTime(2.5f));
        Size(Slicer.transform, new Vector2(3f, 0f), 0.1f, true);
        yield return StartCoroutine(WaitForTime(1f));
        ...
        ChoppingBeam(Color.yellow, 270f, 0.25f, 0f, false, 4f);
        yield return StartCoroutine(WaitForTime(1f));
        SpreadOrbPattern(Color.yellow, new Vector2(5f, 5f), 0f, 4f, 18, 10f);
        yield return StartCoroutine(WaitForTime(0.5f));
        ChoppingBeam(Color.red, GetPlayerDirection(), 1f, 0.25f, true, 7.5f);
        yield return StartCoroutine(WaitForTime(0.25f));
        CameraVibrator.Shake();
        ChoppingBeam(Color.yellow, GetPlayerDirection(), 1f, 0.25f, true, 7.5f);
        yield return StartCoroutine(WaitForTime(0.25f));
        CameraVibrator.Shake();
        ChoppingBeam(Color.red, GetPlayerDirection(), 1f, 0.25f, true, 7.5f);
        yield return StartCoroutine(WaitForTime(0.5f));
        ArenaSize(0.5f, 0.25f, 0.5f, false, Color.red, Color.yellow);
        yield return StartCoroutine(WaitForTime(0.25f));
        Flash(Color.white, 0.5f, 3);
        yield return StartCoroutine(WaitForTime(1.5f));
        SpreadOrbPattern(Color.red, new Vector2(10f, 10f), 180f, 6f, 10, 10f);
        yield return StartCoroutine(WaitForTime(1f));
        SpreadOrbPattern(Color.yellow, new Vector2(10f, 10f), 0f, 6f, 10, 10f);
        yield return StartCoroutine(WaitForTime(0.5f));
        SpreadOrbPattern(Color.red, new Vector2(5f, 5f), 135f, 5f, 5, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        SpreadOrbPattern(Color.yellow, new Vector2(5f, 5f), 225f, 5f, 5, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        SpreadOrbPattern(Color.red, new Vector2(5f, 5f), 180f, 5f, 5, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        SpreadOrbPattern(Color.red, new Vector2(5f, 5f), 135f, 5f, 5, 10f);
        SpreadOrbPattern(Color.yellow, new Vector2(5f, 5f), 225f, 5f, 5, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        ArenaSize(-5f, 1f, 1.25f, false, Color.red, Color.yellow);
        yield return StartCoroutine(WaitForTime(1f));
        SpreadOrbPattern(Color.red, new Vector2(5f, 5f), 270f, 5f, 18, 10f);
        yield return StartCoroutine(WaitForTime(0.5f));
        SpreadOrbPattern(Color.yellow, new Vector2(5f, 5f), 90f, 5f, 18, 10f);
        yield return StartCoroutine(WaitForTime(0.5f));
        LaserCutter(Color.red, 0f, 170f, 0.5f);
        LaserCutter(Color.yellow, -0f, -170f, 0.5f);
        yield return StartCoroutine(WaitForTime(0.5f));
        Flash(Color.white, 0.5f, 3);
        //WinGame();
        #endregion
        ...
        SetToDefaultScheme();
        GameObject.Find("Player").GetComponent<PlayerController>().Speed = 3.5f;
        ChoppingBeam(Color.black, 0f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 90f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 180f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 270f, 0.25f, 0f, false, 2.5f);
        yield return StartCoroutine(WaitForTime(0.25f));
        ChoppingBeam(Color.black, 45f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 135f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 225f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 315f, 0.25f, 0f, false, 2.5f);
        yield return StartCoroutine(WaitForTime(0.25f));
        ChoppingBeam(Color.black, 0f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 90f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 180f, 0.25f, 0f, false, 2.5f);
        ...
        ChoppingBeam(Color.black, 315f, 0.25f, 0f, false, 2.5f);
        yield return StartCoroutine(WaitForTime(0.25f));
        LaserCutter(Color.black, 0f, 170f, 0.25f);
        LaserCutter(Color.black, -0f, -170f, 0.25f);
        yield return StartCoroutine(WaitForTime(0.5f));
        PlayerCrusher(Color.black, new Vector2(2.5f, 100f), 0f, 0.25f);
        PlayerCrusher(Color.black, new Vector2(2.5f, 100f), 0f, 0.25f);
        yield return StartCoroutine(WaitForTime(1f));
        SpreadOrbPattern(Color.black, new Vector2(5f, 5f), 90f, 4f, 21, 10f);
        yield return StartCoroutine(WaitForTime(0.5f));
        SpreadOrbPattern(Color.black, new Vector2(5f, 5f), -90f, 4f, 21, 10f);
        yield return StartCoroutine(WaitForTime(0.35f));
        ChoppingBeam(Color.black, 0f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 145f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, -145f, 0.25f, 0f, false, 2.5f);
        yield return StartCoroutine(WaitForTime(0.35f));
        ChoppingBeam(Color.black, 180f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 55f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, -55f, 0.25f, 0f, false, 2.5f);
        yield return StartCoroutine(WaitForTime(0.35f));
        ChoppingBeam(Color.black, 0f, 0.25f, 0f, false, 2.5f);
        ChoppingBeam(Color.black, 145f, 0.25f, 0f, false, 2.5f);
        ...
        for (int i = 0; i < 3; i++)
        {
            if (i % 2 == 0)
            {
                ...
                DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 90f, 270f, 7f, 4, 10);
            }
            else
            {
                DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 315f, 135f, 7f, 4, 10);
                DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 45f, 225f, 7f, 4, 10);
            }
            yield return StartCoroutine(WaitForTime(0.225f));
        }
        yield return StartCoroutine(WaitForTime(0.5f));
        ...
        PlayerCrusher(Color.black, new Vector2(2.5f, 100f), 0f, 0.25f);
        yield return StartCoroutine(WaitForTime(0.2f));
        SpreadOrbPattern(Color.black, new Vector2(5f, 5f), 0f, 5f, 15, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        SpreadOrbPattern(Color.black, new Vector2(5f, 5f), 180f, 5f, 15, 10f);
        yield return StartCoroutine(WaitForTime(0.25f));
        for (int i = 0; i < 18; i++)
        {
            if (i % 2 == 0)
            {
                ChoppingBeam(Color.black, i * 10, 0.25f, 0f, false, 2.5f);
            }
            else if (i % 2 != 0)
            {
                ChoppingBeam(Color.black, i * 10, 0.25f, 0f, false, 2.5f);
        ...
        for (int i = 0; i < 12; i++)
        {
            if (i % 2 == 0)
            {
                InverseSpreadSquarePattern(Color.black, new Vector2(2f, 2f), UnityEngine.Random.Range(0f, 360f), 7f, 1, 0f);
            }
            else
            {
                InverseSpreadSquarePattern(Color.black, new Vector2(2f, 2f), UnityEngine.Random.Range(0f, 360f), 7f, 1, 0f);
        ...
        HitCheckpoint();
        yield return StartCoroutine(WaitForTime(0.5f));
        Color32 Coloring2 = new Color32(181, 51, 137, 225);
        LaserCutter(Coloring2, 0f, 135f, 1.5f, true);
        LaserCutter(Coloring2, -0f, -135f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1.25f));
        LaserCutter(Coloring2, 0f, 360f, 2f, true);
        yield return StartCoroutine(WaitForTime(2f));
        LaserCutter(Coloring2, 0f, 180f, 1.5f, true);
        LaserCutter(Coloring2, 180f, 360f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1.5f));
        LaserCutter(Coloring2, 0f, 180f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1.5f));
        LaserCutter(Coloring2, 180f, 360f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1.5f));
        LaserCutter(Coloring2, 0f, 90f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1f));
        LaserCutter(Coloring2, 0f, 180f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1f));
        LaserCutter(Coloring2, 0f, 270f, 1.5f, true);
        yield return StartCoroutine(WaitForTime(1.5f));
        SpreadOrbPattern(Coloring2, new Vector2(5f, 5f), 0f, 5f, 28, 10f);
        yield return StartCoroutine(WaitForTime(1.5f));
        SpreadOrbPattern(Coloring2, new Vector2(5f, 5f), 180f, 5f, 28, 10f);
        yield return StartCoroutine(WaitForTime(1f));
        WinGame();
        #endregion
    }
	...
	public IEnumerator infernoSlashes() {
        ...
        WarningArea(Color.black, -130f, -50f, 1.75f);
        WarningArea(Color.black, 50f, 130f, 1.75f);
        ...
        WarningArea(Color.black, 5f, 85f, 1.75f);
        WarningArea(Color.black, 185f, 265f, 1.75f);
        yield return StartCoroutine(Wait (1.75f));
        CameraVibrator.Shake();
        DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 45f, 225f, 7f, 9, 10);
		Flash(Color.white, 0.1f, 1);
        WarningArea(Color.black, 95f, 175f, 1.75f);
        WarningArea(Color.black, 275f, 355f, 1.75f);
        yield return StartCoroutine(Wait (1.75f));
        CameraVibrator.Shake();
        DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 135f, 315f, 7f, 9, 10);
		Flash(Color.white, 0.1f, 1);
        WarningArea(Color.black, -60f, -30f, 1.75f);
        WarningArea(Color.black, 30f, 60f, 1.75f);
        WarningArea(Color.black, -150f, -120f, 1.75f);
        WarningArea(Color.black, 120f, 150f, 1.75f);
        yield return StartCoroutine(Wait (1.75f));
        CameraVibrator.Shake();
		...
		Flash(Color.white, 0.1f, 1);
        WarningArea(Color.black, -15f, 15f, 1.75f);
        WarningArea(Color.black, 165f, 195f, 1.75f);
        WarningArea(Color.black, -105f, -75f, 1.75f);
        WarningArea(Color.black, 75f, 105f, 1.75f);
        yield return StartCoroutine(Wait (1.75f));
        CameraVibrator.Shake();
        DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 0f, 180f, 7f, 4, 10);
		DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), -90f, 90f, 7f, 4, 10);
		Flash(Color.white, 0.1f, 1);
        WarningArea(Color.black, -75f, 75f, 1.75f);
        WarningArea(Color.black, 105f, 255f, 1.75f);
        yield return StartCoroutine(Wait (1.75f));
        CameraVibrator.Shake();
        DoubleSpreadOrbPattern(Color.black, new Vector2(5f, 5f), 0f, 180f, 7f, 16, 10);
